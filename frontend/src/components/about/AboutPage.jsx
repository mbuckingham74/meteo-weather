  ...
  const features = [
    {
      ...
      description:
        'ONE flexible input for simple locations AND complex AI-powered weather queries. Ask naturally, get intelligent answers.',
    ...
    },
    {
      ...
      description:
        'Natural language weather questions powered by Claude Sonnet 4.5. Ask anything from "Will it rain this weekend?" to "Where should I move for better weather?"',
    ...
    },
    {
      ...
      description:
        'Real historical precipitation data with animated radar, storm tracking, weather alerts overlay, and screenshot export.',
    ...
    },
    {
      ...
      description:
        'Compare weather patterns across multiple cities with historical data, interactive charts, and AI-powered location matching.',
    ...
    },
    {
      ...
      description:
        '585,000+ pre-populated weather records for 148 cities spanning 2015-2025. Instant access to 10+ years of climate patterns.',
    ...
    },
    {
      ...
      description:
        'Comprehensive settings with scheduled weather reports, alerts, and cloud-synced preferences across all devices.',
      ...
      <section className="about-hero">
        <div className="hero-content">
          ...
          <p className="hero-description">
            Built as a Weather Spark clone with modern AI capabilities, Meteo delivers instant
            access to decade-long weather patterns, natural language queries, and powerful location
            comparison tools.
          </p>
        </div>
      ...
      <section className="about-why">
        ...
        <div className="why-grid">
          <div className="why-card">
            ...
            <p>
              Pre-populated data means 282x faster queries compared to API calls. Get your weather
              insights instantly.
            </p>
          </div>
          <div className="why-card">
            ...
            <p>
              Ask questions naturally. No more navigating complex menus - just describe what you
              want to know.
            </p>
          </div>
          <div className="why-card">
            ...
            <p>
              Install on any device. Works offline. Native app-like experience on mobile, tablet,
              and desktop.
            </p>
          </div>
          <div className="why-card">
            ...
            <p>
              Your data stays secure. Cloud-synced preferences with JWT authentication and
