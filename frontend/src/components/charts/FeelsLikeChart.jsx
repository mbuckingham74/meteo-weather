      ...
      return (
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <p style={{ margin: 0, color: chartPalette.hot, fontWeight: '500' }}>
              🌡️ Actual High: {data.actualMax}°{unit}
            </p>
            <p style={{ margin: 0, color: chartPalette.warning, fontWeight: '500' }}>
              🔥 Feels Like High: {data.feelsLikeMax}°{unit}
            </p>
            <p style={{ margin: 0, color: chartPalette.cool, fontWeight: '500' }}>
              ❄️ Actual Low: {data.actualMin}°{unit}
            </p>
            <p style={{ margin: 0, color: chartPalette.coolAccent, fontWeight: '500' }}>
        ...
        <ComposedChart data={chartData} margin={{ top: 5, right: 30, left: 25, bottom: 5 }}>
          <defs>
            <linearGradient id="colorFeelsLike" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="95%" stopColor={chartPalette.coolAccent} stopOpacity={0.3} />
            </linearGradient>
          </defs>
