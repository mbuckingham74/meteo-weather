                        ...
                        <div className="highlights-grid">
                          ...
                          <div className="highlight-card">
                            ...
                            <div className="highlight-content">
                              ...
                              <div className="highlight-value">
                                {data.forecast[0]?.uvIndex ??
                                  currentWeather.data.current.uvIndex ??
                                  '--'}
                              </div>
                          ...
                          <div className="highlight-card">
                            ...
                            <div className="highlight-content">
                              ...
                              <div className="highlight-subtext">
                                {currentWeather.data.current.pressure
                                  ? currentWeather.data.current.pressure > 1013
                                    ? 'High'
                                    : 'Low'
                                  : ''}
                              </div>
                        ...
                        <div className="highlights-grid">
                          ...
                          <div className="highlight-card">
                            <div className="highlight-icon">
                              {data.forecast[0]?.snow > 0
                                ? '❄️'
                                : data.forecast[0]?.precipitation > 0
                                  ? '🌧️'
                                  : '☀️'}
                            </div>
                            <div className="highlight-content">
                        ...
                        <div className="weather-summary-card">
                          <div className="summary-main">
                            <span className="summary-icon">
                              {data.forecast[0]?.icon === 'rain'
                                ? '🌧️'
                                : data.forecast[0]?.icon === 'snow'
                                  ? '❄️'
                                  : data.forecast[0]?.icon === 'cloudy'
                                    ? '☁️'
                                    : data.forecast[0]?.icon === 'partly-cloudy-day'
                                      ? '⛅'
                                      : data.forecast[0]?.icon === 'clear-day'
                                        ? '☀️'
                                        : '🌤️'}
                            </span>
                          ...
                          {data.forecast[0]?.precipProbability > 0 && (
                            <div className="summary-precipitation">
                              ...
                              <span className="precip-text">
                                ...
                                {data.forecast[0].precipitation > 0 &&
                                  ` (${data.forecast[0].precipitation.toFixed(1)} mm expected)`}
                              </span>
                            </div>
                          )}
                        </div>
